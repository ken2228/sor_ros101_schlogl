...
def calculate():
	if radius_found and radius_squared_found and height_found and mass_found:
		msg = Cylinder()
		msg.volume = pi * radius_squared * height
		msg.surface_area = 2 * pi * (radius * height + radius_squared)
		msg.mass = msg.volume * mass
		pub.publish(msg)
...
rospy.Subscriber("/mass", Float64, mass_callback)
